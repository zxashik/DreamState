          ...
          <div className="lg:w-2/5">
            ...
            <div className="w-full">
              <img
                ...
                src="https://cdn.tuk.dev/assets/templates/Fabterior/section6(1).png"
                alt
              />
            </div>
            <div className="border-2 border-black px-4 py-10 lg:px-10 bottom-0 mt-8 hidden lg:block">
              <div className="flex flex-col">
                ...
                <div className="text-base md:text-xl lg:text-2xl tracking-tight f-f-l text-gray-700 leading-8">
                  Dreamstate construction is a reliable company that has made
                  its place in the real estate industry of Bangladesh. Our team
                  has built its reputation by quality work over years around the
                  country. we have completed many dynamic projects and
                  established our goodwill in the architectural construction
                  industry of Bangladesh. we are not only building the
                  infrastructure we make happy customers.
                </div>
                <button className="text-base md:text-xl lg:text-2xl  lg:leading-5 f-f-l underline text-left font-bold focus:outline-none text-black-color mt-4 md:mt-6 lg:mt-8">
                  Know More
                </button>
          ...
          <div className="lg:w-3/5 lg:pl-8">
            <div className="xl:h-2/5 lg:mt-0 mt-8">
              <img
                ...
                src="https://cdn.tuk.dev/assets/templates/Fabterior/section6(2).png"
                alt
              />
            </div>
        ...
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              We work for our clients to create environment and experience that
              delight them and their family. As per customer requirement we
              design their house and office with our interior expertise.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <img
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
              S construction always try to offer best possible services and
              products to customers for attaining their full satisfaction, as
              the group endorses the notion that customers are the ultimate
              determining factor in success of any organization. It always
              strives to introduce new products and services to the customers.
            </p>
          ...
          <div className="w-full lg:w-6/12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
              {/* <!-- Team Card --> */}
              <div className="flex p-4 shadow-md hover:shadow-2xl cursor-pointer">
                <div className="mr-6">
                  <svg
                    className="mr-6"
                    width="36"
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    We create value, integrity and bonding with our customers by
              ...
              <div className="flex p-4 shadow-md hover:shadow-2xl cursor-pointer">
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    We believe that customer satisfaction measures our success.
                    We proudly believe in keeping commitments and making future
                    convenient for next generation.
                  </p>
                </div>
              </div>
              ...
              <div className="flex p-4 shadow-md hover:shadow-2xl cursor-pointer">
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    We are here for you, so for any kinds of free consultancy or
                    query contact us
                  </p>
                </div>
              </div>
